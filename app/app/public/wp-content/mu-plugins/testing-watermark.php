...
function codex_testing_watermark_render() {
    ...
    echo '<style id="codex-testing-watermark">\n'
       . '.codex-testing-watermark{position:fixed;z-index:1000;left:12px;bottom:12px;padding:6px 10px;background:#b91c1c;color:#fff;font:600 12px/1.2 system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;border-radius:6px;box-shadow:0 4px 10px rgba(0,0,0,.18);letter-spacing:.06em;text-transform:uppercase;opacity:.9;pointer-events:none}\n'
